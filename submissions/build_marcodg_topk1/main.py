...
# ============================================================================
# topk1 wrapper (= 我家独自 lift、 konbu17 tutorial +75 LB pattern)
# Hypothesis: marcodg base is multi-launch heavy、 1-shot largest fleet で
# Kaggle Kaggle TrueSkill ranking で勝率上昇
# ============================================================================

_orig_agent_marco = agent


def agent(observation, configuration=None):
    moves = _orig_agent_marco(observation, configuration)
    if not moves or len(moves) <= 1:
        return moves
    try:
        return [max(moves, key=lambda m: m[2] if len(m) > 2 else 0)]
    except Exception:
        return moves
