## [MD]
# Orbit Wars Snipe Plus No-BOM Agent

Public Orbit Wars rule-based agent variant derived from the public orbitbotnext family. This notebook writes `main.py` and packages `submission.tar.gz` for submission.

## [CODE]
```python
%%writefile main.py
# Orbit Wars Snipe Plus No-BOM Agent
# Derived from the public orbitbotnext family for Kaggle Orbit Wars.
# UTF-8 no-BOM source.
