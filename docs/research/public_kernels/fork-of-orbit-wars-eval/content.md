...
REPLAY_FOLDER = '/kaggle/input/datasets/zacharymaronek/analyze-for-training'   # change this if your replays live elsewhere
TARGET_AGENT = 'Shun_PI'    # the agent whose play you want to analyze
ONLY_WINS = False            # set False to analyze all games (wins+losses)
```
